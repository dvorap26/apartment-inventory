...
const translations = {
  ...
  cs: {
    appTitle: 'Soupis vybavení bytu',
    language: 'Jazyk',
    english: 'English',
    czech: 'Čeština',
    loginWelcome: 'Vítejte v aplikaci na vytvoření soupisu vybavení bytu',
    loginPrompt: 'Pro pokračování se přihlaste pracovním účtem',
    signIn: 'Přihlásit se Entra ID',
    logout: 'Odhlásit se',
    ...
    loadingInventory: 'Načítám vybavení...',
    error: 'Chyba',
    ...
    yes: 'Ano',
    no: 'Ne',
    roomDetails: 'Detail místnosti',
    itemDetails: 'Detail položky',
    editItem: 'Upravit položku',
    itemId: 'ID položky:',
    roomId: 'ID místnosti:',
    itemsInRoom: 'Položky v místnosti:',
    created: 'Vytvořeno:',
    lastModified: 'Naposledy upraveno:',
    by: 'uživatelem',
    deleteRoom: 'Smazat místnost?',
    deleteItem: 'Smazat položku?',
    confirmDeleteRoom: 'Opravdu chcete tuto místnost smazat?',
    confirmDeleteItem: 'Opravdu chcete tuto položku smazat?',
    roomHasItems: 'Místnost obsahuje položky inventáře',
    roomHasItemsDescription: 'Tato místnost obsahuje {count} položek a nelze ji smazat, dokud nebudou přesunuty nebo odstraněny.',
    pictures: 'Fotografie',
    ...
    preparingExport: 'Připravuji export inventáře...',
    noRoomsToExport: 'Nejsou žádné místnosti k exportu',
    pdfExported: 'PDF bylo úspěsně exportováno',
  },
} as const;
